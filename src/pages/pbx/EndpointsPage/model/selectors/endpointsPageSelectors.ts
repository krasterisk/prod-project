...
export const getEndpointsLimit = (state: StateSchema) => state.endpointsPage?.limit || 9
...
export const getEndpointsOrder = (state: StateSchema) => state.endpointsPage?.order ?? 'asc'
